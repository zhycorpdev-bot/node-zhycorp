...
Appears under "Features" header, `ZhycorpWrapper` subheader:

```
feat(ZhycorpWrapper): add 'getOwner' method
```

Appears under "Bug Fixes" header, `API` subheader, with a link to issue #5:

```
fix(API): show the owner tag properly
